...
export function Dashboard() {
  ...
  return (
    <motion.div className="space-y-6 max-w-6xl" variants={container} initial="hidden" animate="visible">
      ...
      {aniversarianteHoje && (
        <motion.div variants={item} className="flex items-center gap-3 bg-gold/10 border border-gold/30 rounded-xl px-5 py-3.5">
      ...
      {minhaFerias && (
        <motion.div variants={item} className="flex items-center gap-3 bg-navy/5 border border-navy/15 rounded-xl px-5 py-3.5">
